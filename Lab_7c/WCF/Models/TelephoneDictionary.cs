...
namespace WCF.Models
{
    public class TelephoneDictionary
    {
        ...
        {
            string jsonString = File.ReadAllText("D:\\studing_6sem\\6 sem\\ASP\\ASP_Labs\\Lab_7c\\test.json");
            return jsonString;
        }
        ...
        public void saveChange(List<Telephone> telephones)
        {
            ...
            File.WriteAllText("D:\\studing_6sem\\6 sem\\ASP\\ASP_Labs\\Lab_7c\\test.json", jsonString);
        }
    }
}
